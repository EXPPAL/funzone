    ...
    return (
        <header className="text-9xl text-center fixed z-10 w-full left-0 pointer-events-none">
            <div className="container">
                <Logo />
                <div className="md:w-2/3 mt-8 mx-auto md:px-14 mix-blend-screen bg-[left_10px_top_1rem] bg-[length:100%] pointer-events-auto">
                    <div className="flex flex-row flex-wrap justify-center gap-1 pl-3 relative">
